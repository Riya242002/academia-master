            ...
            <div className="registerTutor">
                ...
                <div className="col-md-5 wrap">
                    ...
                    <div className="form-group"> 
                        ...
                        <input id="confirmPassword" type="password" className="p-3"
                         {...getFieldProps('confirmPassword')} /> 
                        {errors.confirmPassword && touched.confirmPassword  ? 
                        (<div style={{color: 'red'}}>{errors.confirmPassword}</div>) :null}
                    </div>
                    <div className="form-group">
                        <label htmlFor="file">Profile</label>
                        <input type="file" name="file" className="form-control-file" id="file"/>
                        {errors.file && touched.file  ? (<div style={{color: 'red'}}>{errors.file}</div>) 
                        :null}
                    </div>
                    <div className="">
